...
|             [ASReview](#asreview)              |  default: TF–IDF (bi-gram); via [Dory-extension](https://github.com/asreview/asreview-dory): Multilingual E5, MXBAI, GTR T5, LaBSE, MPNet | CNN, DNN, LR, LSTM, NB, RF, SVM  |          S, D, U, T          |       R, C, U, M, CL        |
